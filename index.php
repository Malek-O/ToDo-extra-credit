  ...
  <body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(isset($_POST['add_btn'])) {
          ...
          else if (isset($_POST['mark_all_btn'])) {
             mark__all_as_done();
        }
    ...
    <div id="content">
        ...
        <form method="post" id="addForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
           ...
           <div class="buttons">
              ...
              <button type="submit" class="btn" name="mark_all_btn">Mark all as done</button>
           </div>
            <label for="mySelect">Dsiplay by date (last week , etc):</label>
